...
export class Default1724330307824 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sala" ADD "nome" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "sala" ADD "quantidadeDeItens" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(`ALTER TABLE "sala" DROP COLUMN "localizacao"`);
    await queryRunner.query(
      `ALTER TABLE "sala" ADD "localizacao" integer NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "sala" DROP COLUMN "localizacao"`);
    await queryRunner.query(
      `ALTER TABLE "sala" ADD "localizacao" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "sala" DROP COLUMN "quantidadeDeItens"`,
    );
    await queryRunner.query(`ALTER TABLE "sala" DROP COLUMN "nome"`);
    await queryRunner.query(
      `ALTER TABLE "sala" ADD "quantidade" integer NOT NULL`,
    );
